...
SEARCH_URL = "https://boards-api.greenhouse.io/v1/boards/discord/jobs"
...
def scrape_discord():
    ...
    print(f"Discord page 1: {len(current_jobs)} jobs")
    ...
    for job in current_jobs:
        ...
        department = (
            ...
            if departments
            else metadata.get("careers_site_department")
        )
        ...
        jobs.append(
            {
                ...
                "scheduled_weekly_hours": metadata.get(
