...
SEARCH_URL = "https://api.lever.co/v0/postings/spotify"
...
def scrape_spotify():
    ...
    print(f"Spotify page 1: {len(current_jobs)} jobs")
        ...
        jobs.append(
            {
                ...
                "description_body": clean_html_text(
                    job.get("descriptionBody")
                ),
                "additional": clean_html_text(
